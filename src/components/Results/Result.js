                ...
                <div className="flex flex-col">
                    ...
                    <Link href="/profile">
                        <div className="description flex items-center  text-sm">
                            {
                                video.Photo ?
                                <Image width={80} height={80} alt='profile' className="lg:w-10 w-8 lg:h-10 h-8 my-1 ml-15 rounded-full " src={`/Thumbnails/${video.Photo}`}/>
                                :
                                <Image width={80} height={80} alt='profile' className="lg:w-10 w-8 lg:h-10 h-8 my-1 ml-15 rounded-full " src="/img/logo.png"/>
                            }
