...
<div  className="flex justify-center">
    <div  className="bg-purple-600 w-80 h-full rounded-lg mt-3">
        <div  className="relative bg-white mx-2 my-2 rounded-lg shadow-inner shadow-purple-700 space-y-3">
                  ...
                  <div  className="flex justify-center">
                    <Field type={showPassword? "text":"password"} name="password"  id="password_field" placeholder="Your password" 
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"  strokeWidth="1.5" stroke="currentColor" onClick={handleShowPassword} className="w-8 h-8 absolute right-6 mt-4 cursor-pointer text-purple-600" id="show_password" name="eye_show ">
                          ...
                          :
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" onClick={handleShowPassword} className="w-8 h-8 absolute right-6 mt-4 cursor-pointer text-purple-600">
            ...
            <div  className="flex justify-center">
            <button type="submit"
            className={`bg-purple-700 text-white font-bold rounded-lg w-64 h-8 ${loading ? 'animate-pulse' : ''}`}
