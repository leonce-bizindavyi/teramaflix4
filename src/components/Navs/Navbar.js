...
:
  <div className="buttons  flex flex-initial sm:flex space-x-3 sm:items-center sm:justify-center items-center justify-center w-full sm:w-64 h-full   ">
    <button onClick={handleSmsearch}  id="searchBtn"  className=" hover:bg-gray-200 hover:rounded-full w-10 h-10 md:hidden block">
   ...
   <button id="image" className="p-0">
    {
     ...
     { smSearch ?
      <div className="Searchinput2 transition-all bg-blue-500 px-2 top-14 left-9  sm:top-16 sm:left-[4.5rem]  md:top-14 md:left-9  z-50 fixed w-[80%] rounded-md h-12 flex flex-row space-x-2 items-center  overflow-hidden">
        <input  type="search" 
